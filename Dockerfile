...
RUN wget https://storage.googleapis.com/flutter_infra/releases/stable/linux/flutter_linux_1.22.1-stable.tar.xz && \
    tar xf flutter_linux_1.22.1-stable.tar.xz -C $HOME/opt > /dev/null && \
    rm -f flutter_linux_1.22.1-stable.tar.xz
